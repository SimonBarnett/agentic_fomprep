---
name: priority-hours-orchestrator
description: >-
  Standing rules for Priority timesheets: 8h weekdays, Recording Hours, WBS map, draft-then-confirm, overflow, agent-hour scrutiny. CE/Medatech codes are examples.
  Use when /priority-hours-orchestrator or matching hours workflow trigger.
---
